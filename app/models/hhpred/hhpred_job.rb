...
#              logger.debug("WARNING in #{location}: Could not find pdb file for PDB sequence #{template}")
    ...
    @results.push("<BR><B><i class='fa fa-file-text-o'></i> <font face='Verdana, Arial'> &nbsp;Remmert M, Biegert A, Hauser A, S&ouml;ding J (2012) HHblits: lightning-fast iterative protein sequence searching by HMM-HMM alignment. Nature Methods 9 (2), 173-175.</font></B>")
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <B><font face='verdana,arial,helvetica,sans-serif'> &nbsp;Meier A, S&ouml;ding J (2015) Automatic Prediction of Protein 3D Structures by Probabilistic Multi-template Homology Modeling. PLoS Comput Biol 11 (10), e1004343.</font></B>")
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <B><font face='verdana,arial,helvetica,sans-serif'> &nbsp;Hildebrand A, Remmert A, Biegert A, S&ouml;ding J (2009) Fast and accurate automatic structure prediction with HHpred. Proteins 77 (S9), 128-132.</font></B>")
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <B><font face='verdana,arial,helvetica,sans-serif'> &nbsp;S&ouml;ding J, Biegert A, Lupas AN (2005) The HHpred interactive server for protein homology detection and structure prediction. Nucleic Acids Res 33 (suppl 2), W244-W248.</font></B>")
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <B><font face='verdana,arial,helvetica,sans-serif'> &nbsp;S&ouml;ding J (2005) Protein homology detection by HMM-HMM comparison. Bioinformatics 21: 951-960.</font></B>")
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <B><font face='verdana,arial,helvetica,sans-serif'> &nbsp;Biegert A, Mayer C, Remmert M, S&ouml;ding J, Lupas AN (2006) The MPI Bioinformatics Toolkit for protein sequence analysis. Nucleic Acids Res 34 (suppl 2), W335-W339.</font></B>")
