...
#              logger.debug("WARNING in #{location}: Could not find pdb file for PDB sequence #{template}")
    ...
    @results.push("<br></pre>\n")
    @results.push("<h3 class='search'>Please cite one of the following articles:</h3>")
    
    @results.push("<BR><B><a href='https://scholar.google.de/citations?view_op=view_citation&hl=de&user=xjYIe80AAAAJ&citation_for_view=xjYIe80AAAAJ:k_IJM867U9cC' target='_blank' class='fa fa-file-text-o'><font face='Verdana, Arial'> &nbsp;Remmert M, Biegert A, Hauser A, S&ouml;ding J. (2012): HHblits: lightning-fast iterative protein sequence searching by HMM-HMM alignment. Nature Methods 9 (2), 173-175 (2012).</font></a></B>")
    @results.push("<BR><BR><B><a href='https://scholar.google.de/citations?view_op=view_citation&hl=de&user=xjYIe80AAAAJ&sortby=pubdate&citation_for_view=xjYIe80AAAAJ:738O_yMBCRsC' target='_blank' class='fa fa-file-text-o'><font face='verdana,arial,helvetica,sans-serif'> &nbsp;Meier A, S&ouml;ding J. (2015): Automatic Prediction of Protein 3D Structures by Probabilistic Multi-template Homology Modeling. PLoS Comput Biol 11 (10), e1004343 (2015).</font></a></B>")
    @results.push("<BR><BR><B><a href='https://scholar.google.de/citations?view_op=view_citation&hl=de&user=xjYIe80AAAAJ&citation_for_view=xjYIe80AAAAJ:roLk4NBRz8UC' target='_blank' class='fa fa-file-text-o'><font face='verdana,arial,helvetica,sans-serif'> &nbsp;Hildebrand A, Remmert A, Biegert A, S&ouml;ding J (2009): Fast and accurate automatic structure prediction with HHpred. Proteins 77 (S9), 128-132 (2009).</font></a></B>")
    @results.push("<BR><BR><B><a href='https://scholar.google.de/citations?view_op=view_citation&hl=de&user=xjYIe80AAAAJ&citation_for_view=xjYIe80AAAAJ:9yKSN-GCB0IC' target='_blank' class='fa fa-file-text-o'><font face='verdana,arial,helvetica,sans-serif'> &nbsp;S&ouml;ding J., Biegert A., Lupas AN. (2005): The HHpred interactive server for protein homology detection and structure prediction. Nucleic Acids Res 33 (suppl 2), W244-W248 (2005).</font></a></B>")
    @results.push("<BR><BR><B><a href='https://scholar.google.de/citations?view_op=view_citation&hl=de&user=xjYIe80AAAAJ&citation_for_view=xjYIe80AAAAJ:d1gkVwhDpl0C' target='_blank' class='fa fa-file-text-o'><font face='verdana,arial,helvetica,sans-serif'> &nbsp;S&ouml;ding J. (2005): Protein homology detection by HMM-HMM comparison. Bioinformatics 21: 951-960 (2005).</font></a></B>")
    @results.push("<BR><BR><B><a href='https://scholar.google.de/citations?view_op=view_citation&hl=de&user=xjYIe80AAAAJ&citation_for_view=xjYIe80AAAAJ:Tyk-4Ss8FVUC' target='_blank' class='fa fa-file-text-o'><font face='verdana,arial,helvetica,sans-serif'> &nbsp;Biegert A, Mayer C, Remmert M, S&ouml;ding J, Lupas AN (2006): The MPI Bioinformatics Toolkit for protein sequence analysis. Nucleic Acids Res 34 (suppl 2), W335-W339 (2006).</font></a></B>")
    
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>PSIPRED</i>: Jones, D.T. (1999) Protein secondary structure prediction based on position-specific scoring matrices. JMB 292: 195-202.")
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>PDB</i>: Bourne, PE. <i>et al.</i> (2004) The distribution and query systems of the RCSB Protein Data Bank. NAR 32: D223.") if (@cite_pdb >0)
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>SCOP</i>: Andreeva A, Howorth D, Brenner SE, Hubbard TJ, Chothia C, Murzin AG. (2004)     SCOP database in 2004: refinements integrate structure and sequence family data. NAR 32: D226-229.") if (@cite_scop  >0)
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>Interpro</i>: Mulder NJ, Apweiler R, Attwood TK, Bairoch A, Bateman A, Binns D, Bradley P, Bork P, Bucher P, Cerutti L, Copley R, Courcelle E, Das U, Durbin R, Fleischmann W, Gough J, Haft D, Harte N, Hulo N, Kahn D, Kanapin A, Krestyaninova M, Lonsdale D, Lopez R, Letunic I, Madera M, Maslen J, McDowall J, Mitchell A, Nikolskaya AN, Orchard S, Pagni M, Ponting CP, Quevillon E, Selengut J, Sigrist CJ, Silventoinen V, Studholme DJ, Vaughan R, Wu CH. (2005) InterPro, progress and status in 2005. NAR 33: D201-205.") if (@cite_ipro  >0 )
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>Pfam</i>: Bateman A, Coin L, Durbin R, Finn RD, Hollich V, Griffiths-Jones S, Khanna A, Marshall M, Moxon S, Sonnhammer EL, Studholme DJ, Yeats C, Eddy SR. (2004) The Pfam protein families database. NAR 32: D138-141.") if (@cite_pfam  >0)
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>SMART</i>: Letunic I, Copley RR, Schmidt S, Ciccarelli FD, Doerks T, Schultz J, Ponting CP, Bork P. (2004) SMART 4.0: towards genomic data integration. NAR 32: D142-144.") if (@cite_smart  >0 )
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>CDD</i>: Marchler-Bauer A, Anderson JB, Cherukuri PF, DeWeese-Scott C, Geer LY, Gwadz M, He S, Hurwitz DI, Jackson JD, Ke Z, Lanczycki CJ, Liebert CA, Liu C, Lu F, Marchler GH, Mullokandov M, Shoemaker BA, Simonyan V, Song JS, Thiessen PA, Yamashita RA, Yin JJ, Zhang D, Bryant SH. (2005) CDD: a Conserved Domain Database for protein classification.. NAR 33: D192-196.") if (@cite_cdd >0)
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>COG</i>: Tatusov RL, Fedorova ND, Jackson JD, Jacobs AR, Kiryutin B, Koonin EV, Krylov DM, Mazumder R, Mekhedov SL, Nikolskaya AN, Rao BS, Smirnov S, Sverdlov AV, Vasudevan S, Wolf YI, Yin JJ, Natale DA. (2003) The COG database: an updated version includes eukaryotes. BMC Bioinformatics 4: 41.") if (@cite_cog  >0)
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>KOG</i>: Koonin EV, Fedorova ND, Jackson JD, Jacobs AR, Krylov DM, Makarova KS, Mazumder R, Mekhedov SL, Nikolskaya AN, Rao BS, Rogozin IB, Smirnov S, Sorokin AV, Sverdlov AV, Vasudevan S, Wolf YI, Yin JJ, Natale DA. (2004) A comprehensive evolutionary classification of proteins encoded in complete eukaryotic genomes. Genome Biol 5: R7.") if (@cite_kog >0 )
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>PANTHER</i>: Mi H, Lazareva-Ulitsky B, Loo R, Kejariwal A, Vandergriff J, Rabkin S, Guo N, Muruganujan A, Doremieux O, Campbell MJ, Kitano H, Thomas PD. (2005) The PANTHER database of protein families, subfamilies, functions and pathways. NAR 33: D284-288.") if (@cite_panther  >0)
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>TIGRFAMs</i>: Haft DH, Selengut JD, White O. (2003) The TIGRFAMs database of protein families. NAR 31: 371-373.") if (@cite_tigrfam  >0 )
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>PIRSF</i>: Wu CH, Nikolskaya A, Huang H, Yeh LS, Natale DA, Vinayaka CR, Hu ZZ, Mazumder R, Kumar S, Kourtesis P, Ledley RS, Suzek BE, Arminski L, Chen Y, Zhang J, Cardenas JL, Chung S, Castro-Alvear J, Dinkov G, Barker WC. (2004) PIRSF: family classification system at the Protein Information Resource. NAR 32: D112-114.") if (@cite_pirsf  >0)
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>Superfamily</i>: Madera M, Vogel C, Kummerfeld SK, Chothia C and Gough J. (2004) The SUPERFAMILY database in 2004: additions and improvements. NAR 32: D235-D239.") if (@cite_supfam  >0)
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>CATH/Gene3D</i>: Pearl F, Todd A, Sillitoe I, Dibley M, Redfern O, Lewis T, Bennett C, Marsden R, Grant A, Lee D, Akpor A, Maibaum M, Harrison A, Dallman T, Reeves G, Diboun I, Addou S, Lise S, Johnston C, Sillero A, Thornton J, Orengo C. (2005) The CATH Domain Structure Database and related resources Gene3D and DHS provide comprehensive domain family information for genome analysis. NAR 33: D247-D251") if (@cite_CATH  >0 )
    @results.push("<BR><BR><i class='fa fa-file-text-o'></i> <i>PRODOM</i>: Bru, C. <i>et al.</i> (2005) The ProDom database of protein domain families: more emphasis on 3D. NAR 33: D212-215.") if (@cite_prodom  >0)
    #exit(0)
