class HhmakemodelJob  < Job
  ...
  def before_results(controller_params = nil )
    ...
    if(nseqs.to_i <=5&& prob  < 60)
      ...
      @results.push("<br><font color='green'> <b>Need help on how to interpret your results? Click <a href=\"\#\" title=\"HHpred Results\" onclick=\"openHelpWindow('help_results');\">here.<\/a></b></font>")
    end
