...
#      elsif db.gsub!(/(scop|pdb)([^_]\S*)/, '\1\2/db/\1.hhm')
  ...
  def perform
    ...
    @commands << "#{HH}/hhfilter -i #{@basename}.reduced.fas -o #{@basename}.top.a3m -id 90 -qid 0 -qsc 0 -cov 0 -diff 10 -M 30 &> #{job.statuslog_path}"
    ...
    @commands << "#{HH}/parse_jalview.rb -i #{@basename}.tenrep_file -o #{@basename}.tenrep_file"
