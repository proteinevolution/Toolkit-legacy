class HhblitsJob < Job
  ...
  def before_results(controller_params = nil )
    ...
    if  File.exists?("#{basename}.html") && !(program.eql?("align")) && !(program.eql?( "createmodel"))
      @results.push("\n<style type=\"text/css\">\n")
      @results.push("div.slider {position: absolute; height:60px;}\n")
   ...
   # profile_logos
    ...
    @results.push("<BR><BR><B><i>HHblits</i>: Remmert M., Biegert A., Hauser A., and Söding J. HHblits: Lightning-fast iterative protein sequence searching by HMM-HMM alignment. Nat Methods. 2011 Dec 25;9(2):173-5. doi: 10.1038/nmeth.1818</B>")
