class HhblitsAction < Action
  ...
  def prepare_fasta_hhviz_histograms_etc
   ...
   # Build full fasta file here
     @commands << "#{HH}/reformat.pl -r a3m fas #{@basename}_out.a3m #{@basename}.full.fas "
...
#    @commnads << "#{HH}/reformat.pl a3m fas #{@basename}_out.a3m #{@basename}.full.fas -r" 
