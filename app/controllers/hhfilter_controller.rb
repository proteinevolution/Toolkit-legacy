class HhfilterController < ToolController
	...
	def results
		@fw_values = [fw_to_tool_url('hhfilter', 'alnviz'), fw_to_tool_url('hhfilter', 'blastclust'),
		              fw_to_tool_url('hhfilter', 'clans'), fw_to_tool_url('hhfilter', 'cs_blast') + "&fw_mode=alignment" + "&alignment_mode=strict", fw_to_tool_url('hhfilter', 'seq2gi'),
		              fw_to_tool_url('hhfilter', 'hhpred'),
		              fw_to_tool_url('hhfilter', 'hhsenser'), fw_to_tool_url('hhfilter', 'psi_blast') + "&fw_mode=alignment",
