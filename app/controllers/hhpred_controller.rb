...
REFORMAT = File.join(BIOPROGS, 'reformat')
  ...
  def index
    ...
    sortlist = Array["\/pdb70", "\/pdb_on_hold","\/scop95", "\/scop70", "\/scop25", "\/cdd", "\/interpro_", "\/pfamA_", "\/smart", "\/panther_", "\/tigrfam", "\/pirsf", "\/COG", "\/KOG", "\/CATH", "\/supfam", "\/pfam_", "\/pfamB_", "\/cd_", "\/test", "\/Pfalciparum" ]
