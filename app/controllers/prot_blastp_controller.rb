...
class ProtBlastpController < ToolController
  ...
  def results
    ...
    @fw_values = [fw_to_tool_url('prot_blast', 'ancescon')+ "&fw_mode=alignment",
                  fw_to_tool_url('prot_blast', 'alnviz')+ "&fw_mode=alignment",
                  fw_to_tool_url('prot_blast', 'aln2plot')+ "&fw_mode=alignment", 
                  fw_to_tool_url('prot_blast', 'blammer'), 
                  ...
                  fw_to_tool_url('prot_blast', 'frpred') + "&fw_mode=alignment",
                  fw_to_tool_url('prot_blast', 'hhalign') + "&fw_mode=alignment",
                  fw_to_tool_url('prot_blast', 'hhblits') + "&fw_mode=alignment",
                  fw_to_tool_url('prot_blast', 'hhomp') + "&fw_mode=alignment",
                  fw_to_tool_url('prot_blast', 'hhpred') + "&fw_mode=alignment",
                  fw_to_tool_url('prot_blast', 'hhrep') + "&fw_mode=alignment",
                  fw_to_tool_url('prot_blast', 'hhrepid') + "&fw_mode=alignment",
                  ...
                  fw_to_tool_url('prot_blast', 'pcoils') + "&fw_mode=alignment",                  
                  fw_to_tool_url('prot_blast', 'phylip') + "&fw_mode=alignment",
                  ...
                  fw_to_tool_url('prot_blast', 't_coffee') + "&fw_mode=seqs"]
