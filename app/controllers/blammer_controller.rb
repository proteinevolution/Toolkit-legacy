class BlammerController < ToolController
	...
	def results
		@fullscreen = true
		@fw_values = [fw_to_tool_url('blammer', 'ali2d'), fw_to_tool_url('blammer', 'alnviz'),
                              fw_to_tool_url('blammer', 'ancescon'), fw_to_tool_url('blammer', 'blastclust'),
		              fw_to_tool_url('blammer', 'clans'), fw_to_tool_url('blammer','cs_blast'), fw_to_tool_url('blammer', 'seq2gi'),
		              fw_to_tool_url('blammer', 'frpred'),
		              fw_to_tool_url('blammer', 'hhpred'),
		              fw_to_tool_url('blammer', 'hhsenser'), fw_to_tool_url('blammer', 'phylip'), fw_to_tool_url('blammer', 'psi_blast'),
