class ClustalwController < ToolController
	...
	def results
		@fw_values = [fw_to_tool_url('clustalw', 'ali2d'), fw_to_tool_url('clustalw', 'alnviz'),
                              fw_to_tool_url('clustalw', 'ancescon'), fw_to_tool_url('clustalw', 'blastclust'),
		              fw_to_tool_url('clustalw', 'clans'), fw_to_tool_url('clustalw', 'cs_blast'), fw_to_tool_url('clustalw', 'seq2gi'),
		              fw_to_tool_url('clustalw', 'hhpred'), fw_to_tool_url('clustalw', 'hhsenser'),
                              fw_to_tool_url('clustalw', 'phylip'), fw_to_tool_url('clustalw', 'psi_blast'),
